...
module.exports = {
  'Opening the Dropdown with the Mouse': function(browser) {
    ...
    browser.expect.element(prefix + '-1').text.to.not.contain(exampleConstants.HOVERING_SYMBOL);
    browser.expect.element(prefix + '-2').to.be.visible;
    browser.expect.element(prefix + '-2').text.to.not.contain(exampleConstants.HOVERING_SYMBOL);
    browser.expect.element(prefix + '-3').to.be.visible;
    browser.expect.element(prefix + '-3').text.to.not.contain(exampleConstants.HOVERING_SYMBOL);
    browser.expect.element(prefix + '-4').to.be.visible;
    browser.expect.element(prefix + '-4').text.to.not.contain(exampleConstants.HOVERING_SYMBOL);
  ...
  'Closing the dropdown when anywhere else in the document is clicked on': function(browser) {
    browser
      .url('localhost:8000');
  ...
  'Hovering over an element with the Mouse': function(browser) {
    ...
    browser.expect.element(prefix + '-2').text.to.contain(exampleConstants.HOVERING_SYMBOL);

    browser.moveToElement(prefix + '-3', 10, 10);
    browser.expect.element(prefix + '-2').text.not.to.contain(exampleConstants.HOVERING_SYMBOL);
    browser.expect.element(prefix + '-3').text.to.contain(exampleConstants.HOVERING_SYMBOL);
  ...
  'The active state of an element being clicked on': function(browser) {
    ...
    browser.expect.element(prefix + '-3').text.to.contain(exampleConstants.ACTIVE_SYMBOL);
    browser.end();
  },
